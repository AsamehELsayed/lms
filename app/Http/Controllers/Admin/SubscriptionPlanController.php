...
final class SubscriptionPlanController extends Controller
{
    ...
    {
        ResponseService::noPermissionThenRedirect('subscription-plans-list');
    ...
    {
        ResponseService::noPermissionThenRedirect('subscription-plans-create');
    ...
    {
        ResponseService::noPermissionThenRedirect('subscription-plans-edit');
