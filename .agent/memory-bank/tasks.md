...
- [ ] T054 [US8] Run pricing migrations and seeder
...
- [ ] T055 [US9] Create `KashierCheckoutService` in `app/Services/Payment/KashierCheckoutService.php`
...
- [ ] T056 [US9] Register Kashier in `PaymentFactory` in `app/Services/Payment/PaymentFactory.php`
...
- [ ] T057 [US9] Create Kashier webhook handler in `app/Http/Controllers/KashierController.php`
...
- [ ] T058 [US9] Add Kashier settings to admin in `app/Http/Controllers/Admin/SettingsController.php`
...
- [ ] T059 [US9] Modify subscription flow to use Kashier in `app/Services/SubscriptionService.php`
...
- [ ] T060 [US9] Register Kashier webhook route in `routes/web.php`
...
- [ ] T061 [P] [US10] Update permission seeder in `database/seeders/RolePermissionSeeder.php`
...
- [ ] T062 [US10] Rename "Instructor" display labels to "Supervisor" (مشرف)
...
- [ ] T063 [US10] Create admin UI for role/permission assignment
...
- [ ] T064 [US10] Add permission checks to admin controllers
...
- [ ] T065 [US10] Run permissions seeder `php artisan db:seed --class=RolePermissionSeeder`
...
- [ ] T066 [P] [US11] Create migration `add_approval_fields` in `database/migrations/2026_02_16_300001_add_approval_fields_to_ratings_and_discussions.php`
...
- [ ] T067 [US11] Update `Rating` model in `app/Models/Rating.php`
...
- [ ] T068 [US11] Update `CourseDiscussion` model in `app/Models/CourseDiscussion.php`
...
- [ ] T069 [US11] Modify public API to filter by approval status
...
- [ ] T070 [US11] Create admin approval controller in `app/Http/Controllers/Admin/ApprovalController.php`
...
- [ ] T071 [US11] Register approval admin routes
...
- [ ] T072 [US11] Create admin approval UI (optional — Blade views)
...
- [ ] T074 [P] [US12] Create migration `create_marketing_pixels_table` in `database/migrations/2026_02_16_400001_create_marketing_pixels_table.php`
...
- [ ] T075 [US12] Create `MarketingPixel` model in `app/Models/MarketingPixel.php`
...
- [ ] T076 [US12] Create admin `MarketingPixelController` in `app/Http/Controllers/Admin/MarketingPixelController.php`
...
- [ ] T077 [US12] Create public API for active pixels in `app/Http/Controllers/API/MarketingPixelApiController.php`
...
- [ ] T078 [US12] Register marketing pixel routes
...
- [ ] T079 [US12] Create admin marketing pixels view in `resources/views/admin/marketing-pixels/index.blade.php`
...
- [ ] T097 [US17] Add marketing pixels sidebar link in `resources/views/components/sidebar.blade.php`
